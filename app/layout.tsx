...
export const metadata: Metadata = {
  title: "Sarah Mitchell — Calgary's Private Real Estate Office",
  description:
    "A private brokerage for Calgary's most considered residences. Sarah Mitchell — 15 years, $180M+ sold.",
};
